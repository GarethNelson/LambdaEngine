...
static void   (*predraw_text)(void* font, int r, int g, int b, char* text, int *w, int *h, int *text_w, int *text_h, GLuint *tex_out);
...
static void   (*draw_scroll_bg)(float x, float y, float tile_w, float tile_h, float offset, GLuint tex_id);
#endif
